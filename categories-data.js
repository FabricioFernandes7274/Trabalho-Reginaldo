...
const CATEGORIES = {
    ...
    carros:{ key:'carros', title:'Carros', scheme:'scheme-carros', description:'Corridas e velocidade.', games:[
        { id: 'carros-0', title:'Palio de Meu fio', price:19.90, image:'Imagens/carros-0.png', description:'Corra em diversas pistas enquanto leva sua filha na escola e vai trabalhar.' }
    ]},
